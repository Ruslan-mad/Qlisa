...
Qlisa — развиваемый сообществом форк [Inkue от FonograF](https://github.com/FonograF/Inkue). Проект сохраняет формат `.inkue` и некоторые имена для совместимости, а также развивает собственные сценарии воспроизведения, вывода и управления шоу.
