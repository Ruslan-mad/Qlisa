...
Qlisa — развиваемый сообществом форк [Inkue от FonograF](https://github.com/FonograF/Inkue). Новые проекты используют расширение `.qlisa`; старые проекты `.inkue` также поддерживаются, оба расширения используют одну JSON-схему. Ассоциация файлов `.qlisa` в Windows запланирована для Qlisa 1.5.8. Последний выпущенный релиз — 1.5.7.
